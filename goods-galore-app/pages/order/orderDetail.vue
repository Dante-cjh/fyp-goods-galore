	...
	<view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<text class="name">Product Detail</text>
			</view>
			<!-- 商品列表 -->
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Total Amount</text>
				<text class="cell-tip">￥{{order.totalAmount}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Freight Amount</text>
...
<!-- 			<view class="yt-list-cell b-b">
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Order SN</text>
				<text class="cell-tip">{{order.orderSn}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Create Time</text>
				<text class="cell-tip">{{order.createTime | formatDateTime}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Pay Type</text>
			...
			<view class="yt-list-cell b-b" v-if="order.status==1||order.status==2||order.status==3">
				<text class="cell-tit clamp">Pay Amount</text>
		...
		<view class="footer" v-if="order.status==0||order.status==2||order.status==3">
			...
			<view class="action-box b-t" v-if="order.status == 3">
				<button class="action-btn">Apply for service</button>
				<button class="action-btn recom">Review Products</button>
			</view>
