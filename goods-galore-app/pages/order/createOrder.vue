	...
	<view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<text class="name">Product Message</text>
			</view>
			<!-- 商品列表 -->
...
<!-- 		<view class="yt-list">
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">Freight Fee</text>
...
<!-- 			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell desc-cell">
				...
				<input class="desc" type="text" v-model="desc" placeholder="Please write note." placeholder-class="placeholder" />
			</view>
		</view>
		...
		methods: {
			...
			submit() {
				...
				generateOrder(orderParam).then(response => {
					...
					uni.showModal({
						title: 'Tip',
						content: 'Order created successfully, now pay immediately?',
						confirmText:'Pay',
						cancelText:'Cancel',
