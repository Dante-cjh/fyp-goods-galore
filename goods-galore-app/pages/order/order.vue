				...
				<scroll-view class="list-scroll-content" scroll-y @scrolltolower="loadData('add')">
					...
					<view v-for="(item,index) in orderList" :key="index" class="order-item">
						...
						<view class="action-box b-t" v-if="item.status == 0">
							<button class="action-btn" @click="cancelOrder(item.id)">Cancel Order</button>
						...
						<view class="action-box b-t" v-if="item.status == 2">
							...
							<button class="action-btn recom" @click="receiveOrder(item.id)">Confirm received</button>
						</view>
						<view class="action-box b-t" v-if="item.status == 3">
							<button class="action-btn recom" >Review Goods</button>
						</view>
					</view>
			...
			formatStatus(status) {
				...
				switch (+status) {
					...
					case 1:
						...
						break;
					case 2:
						statusTip = 'Waiting to Receive';
						break;
					case 3:
						statusTip = 'Transaction Completed';
						break;
					case 4:
						statusTip = 'Transaction Closed';
						break;
				}
				return statusTip;
			},
