<template>
	<view class="container">
		...
		<view class="f-header m-t" @click="navToRecommendBrandPage()">
			...
			<view class="tit-box">
				<text class="tit">Supplier Goods</text>
				<text class="tit2">Choose Goods from Supplier and Get the best price</text>
			</view>
...
<!-- 		<view class="f-header m-t" v-if="homeFlashPromotion!==null">
		...
		<view class="f-header m-t" @click="navToNewProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">New Goods</text>
				<text class="tit2">I'm looking for new goods in the world for you.</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t" @click="navToHotProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">Popular Recommend</text>
				<text class="tit2">Everyone's raving about it.</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				...
				<text class="tit2">Similar recommendations for good products</text>
			</view>
			<text class="yticon icon-you" v-show="false"></text>
		</view>
