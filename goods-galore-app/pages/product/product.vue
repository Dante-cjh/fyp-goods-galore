...
<!-- 		<view class="share-section" @click="share">
		...
		<view class="c-list">
			...
			<view class="c-row b-b" @click="toggleAttr">
				<text class="tit">Param</text>
				<view class="con">
					<text class="con t-r">Check</text>
				</view>
				<text class="yticon icon-you"></text>
			</view>
<!-- 			<view class="c-row b-b" @click="toggleCoupon('show')">
		...
		<view class="eva-section">
			<view class="e-header">
				<text class="tit">Review</text>
				<text>(86)</text>
				<text class="tip">Praise rate 100%</text>
				<text class="yticon icon-you"></text>
			</view>
			<view class="eva-box">
				...
				<view class="right">
					...
					<view class="bot">
						...
						<text class="time">2024-04-14 19:21</text>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="brand-info">
			...
			<view class="brand-box" @click="navToBrandDetail()">
				...
				<view class="title">
					...
					<text>First Letter: {{brand.firstLetter}}</text>
				</view>
			</view>
		</view>
		...
		<view class="popup spec" :class="specClass" @touchmove.stop.prevent="stopPrevent" @click="toggleSpec">
			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<button class="btn" @click="toggleSpec">Complete</button>
			</view>
		</view>
		<!-- 属性-模态层弹窗 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			toFavorite() {
				...
				if (this.favorite) {
					...
					deleteProductCollection({
						...
						uni.showToast({
							title: "Uncollected successfully!",
							icon: 'none'
						});
			...
			buy() {
				uni.showToast({
					title: "Only orders from the shopping cart are supported!",
					icon: 'none'
				});
			},
			stopPrevent() {},
			...
			checkForLogin() {
				if (!this.hasLogin) {
					uni.showModal({
						title: 'Tip',
						content: "You're not Logoin, should you be?",
						confirmText: 'Login',
						cancelText: 'Cancel',
