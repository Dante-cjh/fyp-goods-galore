	...
	<view class="container">
		...
		<view v-if="!hasLogin || empty===true" class="empty">
			...
			<view v-if="hasLogin" class="empty-tips">
				There is nothing.
				<navigator class="navigator" v-if="hasLogin" url="../index/index" open-type="switchTab">Go shopping!</navigator>
			</view>
		...
		<view v-else>
			...
			<view class="action-section">
				...
				<view class="total-box">
					<text class="price">¥{{total}} RMB</text>
				</view>
	...
	export default {
		...
		methods: {
			...
			createOrder() {
				...
				if(cartIds.length==0){
					uni.showToast({
						title:'You have not selected an item to order!',
						duration:1000
					})
					return;
				}
