      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Enter search:">
            <el-input v-model="listQuery.orderSn" class="input-width" placeholder="Order SN"></el-input>
          </el-form-item>
          <el-form-item label="Receiver:">
            <el-input v-model="listQuery.receiverKeyword" class="input-width" placeholder="Name/Phone"></el-input>
          </el-form-item>
        ...
        <el-table-column label="Operate" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-show="scope.row.status===1">Delivery</el-button>
            <el-button
              size="mini"
              @click="handleViewLogistics(scope.$index, scope.row)"
              v-show="scope.row.status===2||scope.row.status===3">Track</el-button>
            <el-button
              size="mini"
              type="danger"
    ...
    methods: {
      ...
      handleCloseOrderConfirm() {
        if (this.closeOrder.content == null || this.closeOrder.content === '') {
          this.$message({
            message: 'Operation remarks cannot be empty',
            type: 'warning',
            duration: 1000
          });
          return;
