    ...
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" class="form-inner-container" size="small">
      ...
      <el-form-item label="Product Description:">
        <el-input
          ...
          type="textarea"
          placeholder="Please enter something..."></el-input>
      </el-form-item>
      <el-form-item label="Product Sn:">
      ...
      <el-form-item style="text-align: center">
        <el-button type="primary" size="medium" @click="handleNext('productInfoForm')">Next, input product attribute</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
