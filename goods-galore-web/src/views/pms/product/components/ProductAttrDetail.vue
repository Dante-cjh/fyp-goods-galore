<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" class="form-inner-container" size="small">
      ...
      <el-form-item label="Product attribute">
      ...
      <el-form-item label="Commodity Parameters:">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous step, product attributes</el-button>
        <el-button type="primary" size="medium" @click="handleFinishCommit">Done, submit the product</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
    ...
    methods: {
      ...
      handleAddProductAttrValue(idx) {
        ...
        if (this.addProductAttrValue == null || this.addProductAttrValue == '') {
          this.$message({
            message: 'Attribute cannot be null',
            type: 'warning',
            duration: 1000
          });
          return
      ...
      handleRefreshProductSkuList() {
        this.$confirm('Refreshing list will cause sku information to be regenerated, should it be refreshed?', 'Tip', {
