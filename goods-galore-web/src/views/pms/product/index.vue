  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="Label" width="150" align="left">
          <template slot-scope="scope">
            <p>OnShelf:
              <el-switch
        ...
        <el-table-column label="Status" width="100" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button
                type="text"
                @click="handleShowVerifyDetail(scope.$index, scope.row)">Details
              </el-button>
            </p>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      handleEditSkuConfirm(){
        if(this.editSkuInfo.stockList==null||this.editSkuInfo.stockList.length<=0){
          this.$message({
            message: 'No SKU message',
            type: 'warning',
            duration: 1000
          });
          return
        }
        this.$confirm('Confirm to modify', 'Tip', {
      ...
      handleBatchOperate() {
        if(this.operateType==null){
          this.$message({
            message: 'Select batch operation type',
            type: 'warning',
            duration: 1000
          });
          return;
        ...
        if(this.multipleSelection==null||this.multipleSelection.length<1){
          this.$message({
            message: 'Select Product(s)',
            type: 'warning',
            duration: 1000
          });
          return;
        }
        this.$confirm('Confirm to batch operate?', 'Tip', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
