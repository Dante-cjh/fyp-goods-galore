  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="Product Category" width="160" align="center">
          <template slot-scope="scope">{{$route.query.cname}}</template>
        </el-table-column>
        <el-table-column label="Optional" width="120" align="center">
        ...
        <el-table-column label="Value List" align="center">
